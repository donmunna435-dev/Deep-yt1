...
# Telegram bot functions (same as before, but without Flask app creation)
    ...
    <html>
        ...
        <body>
            <div class="container">
                ...
                <p>Copy the code below and send it to your Telegram bot:</p>
                <textarea readonly rows="2">{code}</textarea>
                <p><strong>Instructions:</strong></p>
                <ol>
                    <li>Go back to your Telegram bot</li>
                    <li>Paste this code in the chat</li>
                    <li>The bot will confirm authentication</li>
                </ol>
                <p><em>Note: This code is valid for a limited time.</em></p>
            </div>
        </body>
    </html>
    """
...
@app.route('/health')
def health_check():
    return {"status": "ok", "service": "youtube-upload-bot"}
